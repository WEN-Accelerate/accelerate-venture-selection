-- =====================================================
-- CONSULTANT LAYER SCHEMA - SIMPLIFIED VERSION
-- =====================================================
-- This version works regardless of profiles table structure
...
-- Step 2: Create consultants table (NO foreign key initially)
...
-- Step 3: Create company_assignments table (NO foreign keys initially)
...
BEGIN
    ...
    RAISE NOTICE '1. Create a consultant: UPDATE profiles SET role = ''consultant'' WHERE user_id = ''YOUR_USER_ID'';';
    RAISE NOTICE '2. Add consultant details: INSERT INTO consultants (user_id, consultant_name, email) VALUES (''YOUR_USER_ID'', ''Name'', ''email'');';
END $$;
